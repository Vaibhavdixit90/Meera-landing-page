  ...
  return (
    <>
      <div className="mx-auto max-w-7xl px-4 py-20 md:px-0">
        <div className="pb-20">
          <h2 className="text-bold text-neutral-8000 mx-auto text-left text-xl font-bold tracking-tight md:w-fit md:text-center md:text-4xl">
            Why Choose Meera?
          </h2>
          <p className="mt-4 text-left text-sm md:text-center">
            The Smart Choice for E-commerce Growth
          </p>
        </div>

        <div className="mx-auto w-full bg-white dark:bg-neutral-950">
          <div className="cols-1 grid gap-4 md:auto-rows-[25rem] md:grid-cols-5">
            <Card className="flex flex-col justify-between md:col-span-3">
              ...
              <CardContent className="h-40">
                <CardTitle>Smarter Shopping</CardTitle>
                <CardDescription>
                  Meera&#39;s AI-driven technology delivers an intelligent
                  shopping experience that understands customer needs.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="flex flex-col justify-between md:col-span-2">
              <CardContent className="h-40">
                <CardTitle>Data-Backed Decisions</CardTitle>
                <CardDescription>
                  Make informed decisions with real-time analytics and insights
                  that help you optimize performance.
                </CardDescription>
              </CardContent>
              <CardSkeletonBody>
            ...
            <Card className="flex flex-col justify-between md:col-span-2">
              <CardContent className="h-40">
                ...
                <CardDescription>
                  Seamlessly integrate Meera into any e-commerce platform,
                  enhancing your store without complications.
                </CardDescription>
              </CardContent>
              <CardSkeletonBody>
                <SkeletonTwo />
            ...
            <Card className="flex flex-col justify-between md:col-span-3">
              <CardContent className="h-40">
                <CardTitle>Personalized Engagement</CardTitle>
                <CardDescription>
                  Keep customers engaged and loyal with tailored shopping
...
const CardDescription = ({
  ...
  return (
    <p
      className={cn(
        "mt-2 max-w-xs text-base font-normal tracking-tight text-neutral-500 dark:text-neutral-400",
        className,
      )}
    >
      {children}
