import ExploreMeera from "@/components/ExploreMeera";
...
async function fetchExploreMeeraMetadata() {
  const res = await fetch(
    "https://cms.flowautomate.io/api/explore-meera?populate=Seo.metaImage,Seo.metaSocial.image",
    { cache: "no-store" },
  );
...
export const metadata: Metadata = await fetchExploreMeeraMetadata();
